                ...
                builder.setView(dialogView_buy)
                        ...
                        .setPositiveButton(R.string.really_buy) { dialog, id ->
                            if (money!! - user_input_buy.toDouble() * price_now.toDouble() < 0) {
                                Toast.makeText(applicationContext, "저런...", Toast.LENGTH_SHORT).show()
                            } else {
                                ...
                                Toast.makeText(applicationContext, "매수 완료!", Toast.LENGTH_SHORT).show()
                            }
                        }
                ...
                builder.setView(dialogView_sell)
                        ...
                        .setPositiveButton(R.string.really_sell) { dialog, id ->
                            if (k!! - user_input_sell < 0) {
                                ...
                                Toast.makeText(applicationContext, "매도 완료!", Toast.LENGTH_SHORT).show()
                            }
                        }
                                    .setNegativeButton(R.string.cancel) { dialog, id ->
                                        dialog.cancel()
