                        ...
                        Prices.addValueEventListener(object : ValueEventListener {
                            override fun onDataChange(shot: DataSnapshot) {
                                ...
                                for (snapshot in shot.children) //e.g) snapshot == BTC
                                {
                                    ...
                                    Log.e("@@@@222",k.toString())
                                    if (k!=0) {
                                        val p=snapshot.child("price").value.toString().toDouble()
                                        var total_price = ( p* k!!).toString() + "￦"
                                ...
                                tot = (round(tot!! * 100) / 100).toDouble()
                                di?.text=(tot!!-1000000.toDouble()).toString()+"￦"
