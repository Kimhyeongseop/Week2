...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.senthil.kotlin_tablayout.Fragment.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.senthil.kotlin_tablayout.Fragment.GlideOptions().apply(toSet));
    }
  }
}
